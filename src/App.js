  ...
  return (
    ...
    <div
     className="total_amount_card"
      style={{backgroundImage: "linear-gradient(to right,  rgba(253, 230, 90, 100%), rgba(204, 254, 87, 100%))"}}>
     <div className="right">
     ...
     <form>
      <div className='button_collection'>
       <Stack spacing={2} direction="row">
         ...
         <Button onClick={handleClick2} variant="contained" className='btn_one'>-</Button>
